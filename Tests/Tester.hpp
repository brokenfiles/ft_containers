...
void success_test(const std::string& test_name)
{
	std::cout << "\033[01;32m" << "|- \033[0;32m[OK]\033[01;32m test " << test_name << " is a success\033[0;0m" << std::endl;
}
...
void error_test(const std::string& test_name, const int& status)
{
	...
	std::cout << "\033[01;31m" << "|- \033[0;31m[KO]\033[01;31m test " << test_name << " contains an error\033[0;0m" << std::endl;
}
#endif